...
Environment.LoadFromFile "D:\UFT_AUTOMATION\Config\SFDC_Global_Variables.xml"
...
LoadFunctionLibrary Environment("Application_Functions_Sales")
LoadFunctionLibrary Environment ("Generic_Functions_Sales")
...
oXl.Workbooks.Open Environment ("Control_File_Sales_Cert")
'oXl.Workbooks.Open Environment ("Control_File_Sales_Cert2")
'oXl.Workbooks.Open Environment ("Control_File_Sales_Cert4")
...
'	oTS.cells(TSi,12) = ""
'	oTS.cells(TSi,13) = ""
'	oTS.cells(TSi,12).interior.colorindex = 0
'Next

'Looping through 'Test Case' sheet of Control file
	For rowTC = 47 To 49'sizeTC
...
'oXl.ActiveWorkbook.SaveAs Environment("excelResultPath") & "SF_SALES_REGRESSION_Test_Results_" & timeStamp & ".xlsx"
...
'==========================================
'Find_WebEdit " input", "5", "True", "set_value","5", ""
