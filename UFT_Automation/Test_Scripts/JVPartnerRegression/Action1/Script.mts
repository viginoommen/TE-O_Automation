...
LoadFunctionLibrary Environment("Application_Functions_JV")
LoadFunctionLibrary Environment ("Generic_Functions_JV")
...
oXl.Workbooks.Open Environment ("JVControl_File_Sales_Cert")
